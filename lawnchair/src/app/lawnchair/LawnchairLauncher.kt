...
import app.lawnchair.LawnchairApp.Companion.showSetDefaultLauncherTipIfNecessary
...
class LawnchairLauncher : QuickstepLauncher() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        SensorsAnalyticsSdkHelper.getInstance().trackMC("l_e_set_default_desktop_success")
...
//        showSetDefaultLauncherTipIfNecessary()
    ...
    override fun onResume() {
        ...
        SensorsAnalyticsSdkHelper.getInstance().trackPV("l_p_user_homepage", jsonObject)
        restartIfPending()
