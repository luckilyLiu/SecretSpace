...
public class SimplePushBubble extends SequencePushBubbleInfo {
  ...
  private static class SimplePushPopupWindow extends PopupWindow {
    ...
    public SimplePushPopupWindow(@NonNull Builder builder) {
      ...
      if (builder.needDefaultBackGround) {
  ...
  public static class Builder {
    ...
    private boolean needDefaultBackGround = true;
    ...
    public Builder setNeedDefaultBackGround(@NonNull boolean needDefaultBackGround) {
      this.needDefaultBackGround = needDefaultBackGround;
      return this;
    }
