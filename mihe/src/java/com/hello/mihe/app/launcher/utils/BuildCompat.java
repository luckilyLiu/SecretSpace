...
public class BuildCompat {
  ...
  public static boolean isU() {
    ...
    return (i == 33 && "U".equals(Build.VERSION.CODENAME)) || i >= 34;
  }

  // 13
  public static boolean isT() {
    return Build.VERSION.SDK_INT >= 33
        || (Build.VERSION.SDK_INT == 32 && "T".equals(Build.VERSION.CODENAME));
  }
  ...
  public static boolean isR() {
    return Build.VERSION.SDK_INT >= 30
        || (Build.VERSION.SDK_INT >= 29 && Build.VERSION.PREVIEW_SDK_INT == 1);
  }
