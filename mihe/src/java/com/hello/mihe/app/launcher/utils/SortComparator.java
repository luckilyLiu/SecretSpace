...
public class SortComparator implements Comparator<App> {
    ...
    public int compare(App o1, App o2) {
        compareCallNum = 0;
        return compareString(o1.getLabel(), o2.getLabel());
    }
    ...
    private int compareString(String o1, String o2) {
        ...
        if (isHanzi(o1) && isHanzi(o2)) {
            ...
            //            compareResult = firstPinyinA.compareTo(firstPinyinB);
            compareResult =
                    HanziToPinyin.getSortLetter(o1).first.compareTo(
                            HanziToPinyin.getSortLetter(o2).first);
            if (compareResult != 0) {
                return compareResult;
            }
