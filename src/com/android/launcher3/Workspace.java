...
import com.hello.mihe.app.launcher.MiheWorkspace;
...
public class Workspace<T extends View & PageIndicator> extends PagedView<T>
    ...
    @Override
    public void addInScreen(View child, int container, int screenId, int x, int y, int spanX,
            int spanY) {
        WorkspaceLayoutManager.super.addInScreen(child, container, screenId, x, y, spanX, spanY);
        MiheWorkspace.checkShowHideAppSuccess(child);
    }
}
