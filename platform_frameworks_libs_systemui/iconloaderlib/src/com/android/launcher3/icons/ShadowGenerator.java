...
public class ShadowGenerator {
    ...
    public static class Builder {
        ...
        public Bitmap createPill(int width, int height, float r) {
            ...
            int size = center * 2;
            // Use software bitmap to avoid ANR during initialization.
            // Hardware bitmap creation via Bitmap.createBitmap(Picture) requires waiting for
            // RenderThread synchronization (HardwareRenderer.nCreateHardwareBitmap), which can
            // block the main thread during Launcher.onCreate -> InvariantDeviceProfile ->
            // DeviceProfile -> DotRenderer initialization, causing ANR.
            // The pill bitmap is small (for notification dot shadow), so software bitmap
            // has negligible performance impact.
            return BitmapRenderer.createSoftwareBitmap(size, size, this::drawShadow);
        }
